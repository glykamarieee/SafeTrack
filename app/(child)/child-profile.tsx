  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top", "left", "right"]}>
      ...
      >
        ...
        <Text style={styles.title}>My SafeTrack profile</Text>
        ...
        <View style={styles.profileCard}>
          <View style={styles.avatar}>
            <Text style={styles.avatarText}>
              {context.childName.charAt(0).toUpperCase()}
            </Text>
          </View>
          ...
          <View style={styles.linkedPill}>
            ...
            />
            <Text style={styles.linkedText}>LINKED CHILD PHONE</Text>
          </View>
        </View>

        <Text style={styles.sectionTitle}>LINKED GUARDIAN</Text>
        <View style={styles.card}>
          <Info icon="people-outline" label="Guardian name" value={context.guardianName} />
          <View style={styles.divider} />
          <Info icon="mail-outline" label="Guardian email" value={context.guardianEmail} />
        </View>
        ...
        <View style={styles.card}>
          <Info
            ...
            value={sourceLabel(context.trackingSource)}
          />
          <View style={styles.divider} />
          <Info
        ...
        <View style={styles.note}>
          ...
          <Text style={styles.noteText}>
            Child access is limited to location updates, basic safe-zone
            status, and SOS. Guardian account settings, safe zones, reports,
            and historical records cannot be edited here.
          </Text>
        </View>
        ...
        >
          ...
          <Text style={styles.disconnectText}>Disconnect child phone</Text>
        </Pressable>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  name: { color: colors.ink, fontSize: 21, fontWeight: "900", marginTop: 13 },
  linkedPill: {
    flexDirection: "row",
    alignItems: "center",
  ...
  infoValue: { color: colors.ink, fontSize: 12.5, lineHeight: 17, fontWeight: "800", marginTop: 2 },
  ...
  noteText: { flex: 1, color: colors.primaryDark, fontSize: 11, lineHeight: 16, marginLeft: 8 },
  disconnectButton: {
    minHeight: 54,
    flexDirection: "row",
    alignItems: "center",
  ...
  disconnectText: { color: colors.danger, fontSize: 14, fontWeight: "900", marginLeft: 8 },
