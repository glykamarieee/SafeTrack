...
import {
  ...
  exportAdminSummaryPdf,
} from "../../services/adminReportExportService";
import {
...
export default function AdminReportsScreen() {
  ...
  const [summary, setSummary] = useState<AdminReportSummary | null>(
    null
  );
  const [loading, setLoading] = useState(true);
  const [refreshing, setRefreshing] = useState(false);
  const [exporting, setExporting] = useState<"pdf" | "csv" | null>(
    null
  );
  ...
  const exportPdf = async () => {
    ...
    try {
      await exportAdminSummaryPdf(summary, startDate, endDate);
    } catch (reason) {
      Alert.alert(
        "PDF export error",
        reason instanceof Error
          ? reason.message
          : "SafeTrack could not export the PDF report."
      );
    } finally {
      setExporting(null);
    }
  ...
  const exportCsv = async () => {
    ...
    try {
      await exportAdminSummaryCsv(summary, startDate, endDate);
    } catch (reason) {
      Alert.alert(
        "Excel CSV export error",
        reason instanceof Error
          ? reason.message
          : "SafeTrack could not export the Excel-compatible CSV report."
      );
    } finally {
      setExporting(null);
    }
    ...
    <SafeAreaView style={styles.safe} edges={["top", "left", "right"]}>
      ...
      >
        ...
        <Text style={styles.subtitle}>
          ...
          export the summary as PDF or Excel-compatible CSV.
        </Text>
          ...
          <>
            ...
            <View style={styles.summaryGrid}>
              <SummaryTile
                ...
                value={summary.guardianAccounts}
              />
              ...
              <SummaryTile
                ...
                value={summary.smartwatchDevices}
                color="#2875A8"
                background="#E9F4FC"
              />
              ...
              <SummaryTile
                icon="shield-outline"
                label="Safe-Zone Events"
                value={summary.safeZoneEvents}
              />

              <SummaryTile
                icon="warning-outline"
                label="SOS Records"
                value={summary.sosRecords}
                color={colors.danger}
            ...
            <View style={styles.activityCard}>
              <View style={styles.activityHeader}>
                <View>
                  ...
                  <Text style={styles.activitySubtitle}>
                    Successfully stored records for the selected period.
                  </Text>
                </View>
              ...
              <View style={styles.activityRow}>
                ...
                <Text style={styles.activityText}>
                  {summary.locationRecords} location record
                  {summary.locationRecords === 1 ? "" : "s"} retrieved.
                </Text>
              </View>
              ...
              <View style={styles.activityRow}>
                ...
                <Text style={styles.activityText}>
                  {summary.safeZoneEvents} safe-zone event
                  {summary.safeZoneEvents === 1 ? "" : "s"} retrieved.
                </Text>
              </View>
              ...
              <View style={styles.activityRow}>
                ...
                <Text style={styles.activityText}>
                  {summary.sosRecords} SOS record
                  {summary.sosRecords === 1 ? "" : "s"} retrieved.
                </Text>
              </View>
            </View>
            ...
            <View style={styles.exportRow}>
              ...
              >
                ...
                <Text style={styles.csvButtonText}>Excel CSV</Text>
              </Pressable>
            </View>

            <Text style={styles.exportNote}>
              Excel CSV works with Microsoft Excel, Google Sheets, and similar
